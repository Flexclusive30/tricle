  ...
  return (
    <main className="min-h-screen">
      ...
      <section className="container mx-auto py-8 px-4">
        <h2 className="text-2xl font-bold mb-4">Entertainment Venues Map</h2>
        <p className="text-muted-foreground mb-6">
          Discover entertainment venues across Eswatini. From live music venues to cultural performances, find the
          perfect spot for your evening out.
        </p>
